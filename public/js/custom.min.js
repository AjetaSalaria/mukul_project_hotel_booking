...
// Kitchen Order update status start
    $(".kitchenorder_button").click(function(){
    var orderId = $(this).data('id');
    $.ajax({
        url: '/acceptkitchenorder',
        type: 'GET',
        data: {orderId:orderId}, 
            success: function(res){
                if(res.success){
...
// Kitchen Order update status end

// Room Order update status start

    $(".roomorder_button").click(function(){
    var orderId = $(this).data('id');
    $.ajax({
        url: '/acceptroomorder',
        type: 'GET',
...
// Room Order update status end

//Single item delete status start
...
//Single item delete status end

//Order delete status start
...
(function ($) {
    ...
    $(".nav-control").on('click', function () {
        if(window.location.pathname.split("/").pop() == 'roomservice' || window.location.pathname.split("/").pop() == 'foodservice'){
...
// const sr = new PerfectScrollbar('.sidebar-right-inner');
    ...
    // Checkout page get user name and save to cookie.
    var timer;
    $('#orderForm #name').keyup(function () {
        clearTimeout(timer);
        timer = setTimeout(function (event) {
            var text = $('#orderForm #name').val();
            setCookie('user_name',text,365);
            console.log("cookie user name set: "+text);
        }, 1500);
    });
